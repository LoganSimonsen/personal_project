  ...
  constructor() {
    ...
    this.state = {
      ...
      chartData: {
        maintainAspectRatio: false,
        responsive: true,
        labels: [10.0, 10.05, 10.1, 10.15, 10.2, 10.25, 10.3],
        datasets: [
          {
            label: "Approvals",
            fill: true,
        ...
        datasets: [
          {
            ...
            hoverBackgroundColor: ["rgb(41, 255, 56)", "red"]
          }
        ]
      }
    };
    ...
    return (
      ...
      >
        <div className="BarChartWrapper">
          ...
          {window.location.href.includes("BarChart") &&
...
export default withRouter(
  connect(mapStateToProps, { getUser, logout })(BarChart)
);
